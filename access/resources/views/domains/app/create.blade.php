...
<form method="post" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="box p-5 mt-5">
        <div class="p-2 form-check">
            ...
            <label for="app-shared" class="form-check-label">Password shared with other users</label>
        </div>

        <div class="p-2 form-check">
            <input type="checkbox" name="editable" value="1" class="form-check-switch" id="app-editable" {{ $REQUEST->input('editable') ? 'checked' : '' }}>
            <label for="app-editable" class="form-check-label">Other users can edit this Password</label>
        </div>
